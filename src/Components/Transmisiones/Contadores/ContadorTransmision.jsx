  ...
  return (
    <div className="flex flex-col px-10">
      {transmision ? (
        ...
        <div className="flex flex-col items-center px-10 justify-center lg:flex-row lg:items-center">
          ...
          <div className="order-first lg:order-last flex items-center justify-center w-full lg:w-auto">
            <img
              className="object-cover w-full h-auto md:max-w-xl lg:max-w-none rounded-lg shadow-lg lg:rounded-lg lg:shadow-md lg:h-auto"
              src={img}
