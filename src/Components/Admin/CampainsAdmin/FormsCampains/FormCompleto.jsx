...
export default function FormCompleto({ idCampain }) {
  ...
  useEffect(() => {
    const fetchCampaign = async () => {
      try {
        console.log("ID de la campaña:", idCampain); 
        const response = await axios.get(`/campein/${idCampain}`);
        const campaignName = response.data.name;
        console.log("Nombre de la campaña en el formulario:", campaignName); 
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        console.log("Datos enviados:", values); // Agrega esta línea para verificar los datos
  ...
  return (
    ...
    >
      ...
      <div
        className=""
      >
        <h1 className="text-xl text-gray-700 font-bold text-center mb-6">
        ...
        <form onSubmit={formik.handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="mt-1 text-gray-700 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md"
            >
          ...
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full px-3 text-gray-700 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
            />
            ...
            <div className="flex items-center w-full">
              ...
              <div className="flex px-10 items-center ">
                ...
                <input
                  ...
                  className="ml-2 flex-1 text-gray-700 mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                />
              </div>
            </div>
