...
export default function CrearPlan({ onSuccess, onError }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("/plan", updatedFormData);
  ...
  return (
    <div className="max-w-md mx-auto mt-4 p-4 bg-white rounded-lg shadow-md">
      <h2 className="text-2xl font-bold mb-4 text-center">Crear Nuevo Plan</h2>
