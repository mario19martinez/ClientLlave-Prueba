      ...
      <div className="w-full h-full bg-blue-50">
        ...
        <div className="relative px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          ...
          <div className="grid max-w-screen-lg gap-10 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mx-auto">
            {[
              { title: 'Semanal', price: '$7', duration: '/ Dolares', features: ['Un módulo', '1 semana', 'Cuestionarios', 'Material de apoyo', 'Talleres'] },
              { title: 'Mensual', price: '$15', duration: '/ Dolares', features: ['4 módulos', '1 mes', 'Cuestionarios', 'Material de apoyo', 'Talleres'] },
              { title: 'Nivel', price: '$40', duration: '/ Dolares', features: ['12 módulos', '4 meses', 'Cuestionarios', 'Material de apoyo', 'Talleres'] },
              { title: 'Completo', price: '$70', duration: '/ Dolares', features: ['4 niveles', '1 año', 'Cuestionarios', 'Material de apoyo', 'Talleres'] },
            ].map((plan, index) => (
                ...
                <div className="p-8 bg-blue-900 rounded-lg shadow-lg">
                  <div className="mb-4 text-center">
                    ...
                    <div className="flex items-center justify-center">
                      ...
                      <p className="text-lg text-blue-500">{plan.duration}</p>
                    </div>
                  </div>
                  ...
                  <button
                    type="submit"
                    className="inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide text-blue-900 transition duration-200 rounded shadow-md bg-teal-400 hover:bg-teal-700 focus:shadow-outline focus:outline-none"
                  >
                    Comprar Ahora
                  </button>
                </div>
