...
const registroHistorial = async (actionType, certificado) => {
  ...
  const handleDownloadPDF = async () => {
    const certificadoElement = document.getElementById("certificado-modulo");
      ...
      {certificados.length > 0 ? (
        <div className="overflow-x-auto">
          <table className="min-w-full bg-white shadow-md rounded-lg overflow-hidden">
            <thead className="bg-gray-200 text-gray-600">
              <tr>
                <th className="py-3 px-6 text-left">Módulo del Certificado</th>
              ...
              {certificados.map((certificado) => (
                ...
                >
                  <td className="py-3 px-6 border-b">
                    {modulos[certificado.moduloId] || "Cargando..."}
                  </td>
                  <td className="py-3 px-6 border-b">
        ...
        <div className="flex flex-col items-center justify-center mt-10">
          <p className="text-xl text-gray-500">
            No tienes certificados de módulos disponibles.
          </p>
        </div>
      )}
          ...
          <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle w-full px-2 py-2">
              <div className="bg-white">
                <div id="certificado-modulo" className="sm:p-4">
                  <CertificadoModulo
