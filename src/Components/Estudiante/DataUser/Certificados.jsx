...
export default function Certificados() {
  ...
  const [showAgregarDocumentos, setShowAgregarDocumentos] = useState(null);
  ...
  return (
    <div className="container mx-auto p-4">
          ...
          <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle w-full px-2 py-2">
              <div className="bg-white">
                <div id="certificado" className="sm:p-4"> {/* Añadimos padding solo en dispositivos grandes */}
                  <CertificadoStudent
      ...
      {showAgregarDocumentos && selectedCertificado &&  (
        <AgregarDocumentos
          onClose={() => setShowAgregarDocumentos(false)}
          idUser={userData.sub}
