...
function GrupoDetailUser() {
  ...
  return (
    <div className="absolute translate-x-80 translate-y-10 max-w-lg mx-auto p-4 w-1/2">
      ...
      <ul>
        {modulos.map((modulo) => (
          ...
          <li className="mb-4 border-2 border-blue-500 rounded h-auto p-2 w-72">
            <h4 className=" pl-2 text-lg text-gray-800 font-semibold p-0">{modulo.titulo}</h4>
            <p className="text-gray-700 pl-2">{modulo.descripcion}</p>
          </li>
          </Link>
        ))}
      </ul>
