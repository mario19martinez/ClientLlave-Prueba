...
export default function Banners() {
  ...
  return (
    <div className="py-5 px-3 flex flex-col md:flex-row">
      {/* Imagen que ocupa el 50% en pantallas grandes y 100% en móviles */}
      ...
      {/* Contenido de texto que ocupa el 50% en pantallas grandes y 100% en móviles */}
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center">
          <div className="bg-white p-4 rounded-lg">
            <img src={banner} alt="Banner" style={{ maxWidth: "90vw", maxHeight: "90vh" }}/>
            <button onClick={toggleModal} className="mt-2 px-4 py-2 bg-red-500 text-white rounded hover:bg-red-700 transition duration-300">Cerrar</button>
          </div>
        </div>
      )}
    </div>
